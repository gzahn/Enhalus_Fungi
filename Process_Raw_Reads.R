...
saveRDS(seqtab.nochim, "./Output/MUX8041_seqtab.nochim.RDS")

# Reload Point
seqtab.nochim = readRDS("./Output/MUX8041_seqtab.nochim.RDS")

# import metadata ####
meta = read.csv("./sample_mapping_data.csv")
meta = meta[meta$RunID == "MUX8041",]
...
saveRDS(seqtab.nochim, file = "./Output/MUX8041_clean_dada2_seqtable.RDS")

# Re-load point ####
seqtab.nochim <- readRDS(file = "./Output/MUX8041_clean_dada2_seqtable.RDS")
...
write.csv(as.data.frame(seqtab.nochim), file = "./Output/MUX8041_SeqTable_no-chimera_no-contams_w_Taxonomy.csv", row.names = TRUE, quote = FALSE)
saveRDS(seqtab.nochim, file = "./Output/MUX8041_clean_dada2_seqtable_w_taxonomy.RDS")
saveRDS(taxa, file = "./Output/MUX8041_Taxonomy_from_dada2.RDS")
seqs <- getSequences(seqtab.nochim)

# Hand off to Phyloseq ####

seqtab.nochim = readRDS(file = "./Output/MUX8041_clean_dada2_seqtable_w_taxonomy.RDS")

taxa = readRDS(file = "./Output/MUX8041_Taxonomy_from_dada2.RDS")

unique(taxa[,2])

ps.MUX8041 <- phyloseq(otu_table(seqtab.nochim, taxa_are_rows=FALSE), 
               sample_data(meta), 
               tax_table(taxa))


# Save RDS object for Phyloseq
saveRDS(ps.MUX8041, file = "./Output/MUX8041_clean_phyloseq_object.RDS")
